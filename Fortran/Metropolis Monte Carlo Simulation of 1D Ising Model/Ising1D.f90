...
program Ising1D
	...
	nDisc=200000								!number of initial cycles to be discarded
	...
	! do i=1,n
	! 	r=rand()
	! 	S(i)=(-1)**nint(r)						!there is 3 methods, 1st is randomly oriented spins
	! enddo
...
subroutine TotEnergy(uTot)
    ...
    uTot=0.0d0
	do i=1,n-1
		uTot=uTot-S(i)*S(i+1)						!adding each pair energy
	enddo
