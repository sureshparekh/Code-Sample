...
program Q6B
    ...
    open(1,file='Position-A.txt', status='unknown')
    open(2,file='Velocity-A.txt', status='unknown')
    open(3,file='Position-B.txt', status='unknown')
    open(4,file='Velocity-B.txt', status='unknown')

    !------------------------ Initialzation ---------------------------------------------
    G=1.0d0        ! G=Universal Gravitational Constant
    dt=0.001         !increment 
    t0=0.0         !initial time
